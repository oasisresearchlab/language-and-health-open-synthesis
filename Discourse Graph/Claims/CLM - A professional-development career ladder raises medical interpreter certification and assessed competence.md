...
nodeInstanceId: 019ebef0-9311-7ff3-aa9f-bf5a935e3c2e
tags:
  - languageConcordanceFactor/concordanceIntervention/interpretingServices
  - healthOutcome/interpreterCompetence
  - epistemic/measurement
languageConcordanceFactor:
  - Interpretation services
healthOutcome:
  - Interpreter competence / certification
deliveryContext:
  - Inpatient
...
> [!info] EVDs that support this claim (→ EVD—supports→CLM edges by sync_relations.py). Pre-post evidence that a structured professional-development program raised interpreter credentialing and standardized assessment scores.

- [[EVD - All interpreter staff became nationally certified and mean assessment scores rose after the career-ladder intervention - @Marshall_2016_Creating_Professional]]
