...
nodeInstanceId: 019ebef0-886a-7ee5-8b77-db9a6b5623e9
tags:
...
> [!info] EVDs that support this claim (→ EVD—supports→CLM edges by sync_relations.py). Qualitative accounts of how clinicians' discretionary judgments gate interpreter use.

- [[EVD - Clinicians triaged encounters as noncritical and withheld interpreters reserving them for consents - @Jennifer_2023_Evaluation_Patient]]
