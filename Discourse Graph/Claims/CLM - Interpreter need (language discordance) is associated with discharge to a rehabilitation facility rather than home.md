...
nodeInstanceId: 019ec1ca-39a5-7f4c-9a6e-a4d951f8ff9c
certainty:
tags:
...
> [!info] EVDs that support this claim (→ EVD—supports→CLM edges by sync_relations.py). Adjusted analyses finding that interpreter-requiring (language-discordant) patients are more likely to be discharged to a facility than home.

- [[EVD - Interpreter-cohort TSA patients were 454 percent more likely to be discharged to a rehabilitation facility - @Kyle_2023_Association_Between]]
