...
nodeInstanceId: 019ebef0-6fe9-7fbf-a3f4-fbe6d2e0f352
tags:
...
> [!info] EVDs that support this claim (→ EVD—supports→CLM edges by sync_relations.py). Interventions/analyses showing interpreter receipt or convenient interpreter access is not associated with higher hospital cost — and can produce net savings.

- [[EVD - No significant difference in hospital cost between LEP patients who did and did not receive an interpreter after casemix adjustment - @Morris_2021_Factors_associated]]
...
> [!info] EVDs that oppose this claim (→ EVD—opposes→CLM). None identified among the cost-outcome evidence in this theme.
