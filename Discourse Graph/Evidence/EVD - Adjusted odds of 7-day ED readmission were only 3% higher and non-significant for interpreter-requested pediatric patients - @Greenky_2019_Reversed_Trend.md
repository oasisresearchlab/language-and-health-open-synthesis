...
nodeInstanceId: 019ebed0-d326-70b6-a4c2-581cbe107b9c
...
> [!info] The observable: whether a patient returned to the ED within seven days (ED readmission within 7 days), recorded per encounter from the EPIC EMR.
>
...
> [!info] Retrospective cohort study; ED readmission modeled with logistic regression adjusted for age at baseline, insurance status, means of arrival, and maximum acuity, reported as adjusted odds ratios with 95% CIs. Effect sizes (Cohen's d) prioritized over p-values given the large sample.
>
