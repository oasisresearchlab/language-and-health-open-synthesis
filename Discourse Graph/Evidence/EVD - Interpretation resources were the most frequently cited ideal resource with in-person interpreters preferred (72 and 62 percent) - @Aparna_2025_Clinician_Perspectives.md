...
nodeInstanceId: 019ebed0-ce8f-7197-a907-07be8269ebe6
...
> [!info] The observable: clinician-named "ideal resources" coded from structured interviews, here the frequency with which providers named interpretation resources (and the modality/training preferred).
>
...
> [!info] Structured Zoom interviews with an IRB-approved script, analyzed with directed content analysis guided by modified grounded theory; themes not mutually exclusive (one response could be coded to multiple themes).
>
...
> [!info] 29 US hearing-health clinicians (16 otologists/neurotologists, 13 audiologists) across 4 regions; LEP patients averaged 34% of their practice (range 5%–90%).
>
