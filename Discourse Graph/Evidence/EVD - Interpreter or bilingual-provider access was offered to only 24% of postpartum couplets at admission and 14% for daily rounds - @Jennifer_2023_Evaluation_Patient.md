...
nodeInstanceId: 019ebed1-bce9-776d-8d20-2479ed71efb5
...
> [!info] The observable: the proportion of sampled postpartum encounters (admission, daily rounds, discharge) at which interpretation service or a certified Spanish-speaking provider was offered or used, abstracted from the EHR.
>
...
> [!info] Cross-sectional retrospective chart review: clinician notes and interpreter-service logs in the EHR were reviewed for each couplet to record whether interpretation services were offered, used, or declined per encounter type; analyzed with descriptive statistics in Excel.
>
