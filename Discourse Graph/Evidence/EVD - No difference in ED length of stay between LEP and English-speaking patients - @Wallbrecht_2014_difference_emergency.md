...
nodeInstanceId: 019ebed4-c42b-70d9-9d89-749d6ed064cd
...
> [!info] The observable: mean ED length of stay in minutes, captured as time stamps at transition points (arrival, triage, provider, discharge/admission) and compared between LEP and ES groups.
>
...
> [!info] Prospective convenience-sampling cohort study; investigators selected 2–8 patients per day and for each ES patient matched one LEP patient of the same acuity and similar age, comparing mean LOS with a grouped t test; 80% power to detect a 120-minute difference at >100 per group.
>
