...
nodeInstanceId: 019ebed1-9c66-712c-8b54-1d467dc51947
...
> [!info] The observable: presence of translated, language-concordant paperwork for the surgical consent form and/or the discharge documents, abstracted from the EMR; discharge concordance categorized as full, partial (only pre-populated areas), or none.
>
...
> [!info] Retrospective cohort study; two independent researchers abstracted documentation of language-concordant paperwork from the EMR (Epic Penn Chart).
>
...
> [!info] 228 LEP patients aged ≥18 undergoing cholecystectomy across five University of Pennsylvania Health System hospitals (Jan 2021–Jan 2024); predominantly Hispanic (85%) and Spanish-speaking (87%).
>
