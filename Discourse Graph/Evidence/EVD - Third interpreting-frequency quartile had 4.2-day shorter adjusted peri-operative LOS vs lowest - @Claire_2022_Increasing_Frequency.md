...
nodeInstanceId: 019f8c54-cd68-7eed-9703-441c70688c81
...
In the adjusted multiple linear regression, patients in the third interpreting-frequency quartile (quartile 3, 1.00–1.49 interpreting events/day) had a peri-operative length of stay 4.2 days shorter than the lowest-frequency reference quartile 1, a statistically significant difference (95% CI -7.6 to -0.7, P = 0.02) (Table 3A). Together with the quartile-4 result this defines the significant upper half of the exposure-response gradient.

> "was statistically significantly shorter by 4.2 d in quartile 3 (CI -7.6 to -0.7, P = 0.02)" (de Crescenzo, 2022, p. 183)

> "Quartile 3 -4.2 (-7.6 to -0.7) 0.02" (de Crescenzo, 2022, p. 182, Table 3A)
...
Quartile 3 = "One event per day to less than three events in 2 d (1.00-1.49 interpreting events per day)."
