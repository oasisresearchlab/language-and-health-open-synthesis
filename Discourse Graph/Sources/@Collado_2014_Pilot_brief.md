...
author: Collado
citekey: "@Collado_2014_Pilot_brief"
has_empirical_findings: true
intervention: Brief Behavioral Activation Treatment for Depression (BATD)
journal: Behavior Therapy
keywords: |
  Spanish-speaking Latinos; behavioral activation; depression; treatment development.
language: Spanish
...
title: "Pilot of the brief behavioral activation treatment for depression in latinos with limited english proficiency: preliminary evaluation of efficacy and acceptability"
year: 2014
factors:
  - Limited English Proficiency (LEP)
nodeInstanceId: 019e8dd8-2877-70a6-892c-aea2481f3845
---


## Possible evidence

- Depressive symptomatology significantly decreased (p<.001) over the course of treatment. #evd-candidate
- Activity activation significantly increased (p=.04) during the intervention. #evd-candidate
- Environmental reward significantly increased (p=.02) during the intervention. #evd-candidate
- Increases in activation corresponded concurrently with decreases in depression (p=.01). #evd-candidate
- Environmental reward preceded decreases in depressive symptomatology (all p's ≤ .04). #evd-candidate
- Follow-up analyses revealed sustained clinical gains in depression and activation. #evd-candidate
- Follow-up analyses showed an increase in environmental reward at the one-month follow-up. #evd-candidate
