...
author: Denson
citekey: "@Denson_2022_Language_Assistance"
has_empirical_findings: true
intervention: false
journal: Health Equity
keywords: |
  interpreters; LEP; safety-net clinics.
language: Spanish, Arabic, Russian
...
title: Language Assistance Services in Nonfederally Funded Safety-Net Medical Clinics in the United States
year: 2022
factors:
...
nodeInstanceId: 019e8dd8-28f2-7410-bb37-39cf6b7777af
---


## Possible evidence

- Among 859 eligible clinics, 216 completed the survey with a 24% response rate. #evd-candidate
- Only 18.5% of clinics reported timely access to professional in-person interpreter services. #evd-candidate
- Only 23% of clinics reported timely access to professional phone interpreter services. #evd-candidate
- Only 7% of clinics reported timely access to professional video interpreter services. #evd-candidate
- 80% of clinics used ad hoc family members or friends to interpret. #evd-candidate
- 53% of clinics used ad hoc children to interpret. #evd-candidate
- 78% of clinics reported using bilingual staff, providers, and/or volunteers. #evd-candidate
- Only 22 clinics (11%) provided staff/volunteer training for interpretation. #evd-candidate
