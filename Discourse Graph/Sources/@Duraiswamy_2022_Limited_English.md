...
author: Duraiswamy
citekey: "@Duraiswamy_2022_Limited_English"
has_empirical_findings: true
intervention: awareness of HNC in the LEP populations, and earlier detection may improve outcomes for LEP patients.
journal: American Journal of Otolaryngology
keywords: |
  Head and neck cancer; Limited English proficiency; cancer outcomes.
language: all
...
nodeInstanceId: 019e8dd8-29a4-7874-8b5f-b3b0f7666863
---


## Possible evidence

- Of 477 total patients, 426 (81%) were English proficient (EP) and 51 (10.7%) had limited English proficiency (LEP). #evd-candidate
- LEP patients were diagnosed with cancer at a later overall stage (p = 0.03). #evd-candidate
- LEP patients were less frequently treated with surgery alone compared to English speaking patients (p < 0.001). #evd-candidate
- After adjusting for overall stage and primary site, LEP patients were significantly more likely to receive primary surgical management compared to primary non-surgical management [OR = 2.29, 95% CI (0.93, 5.58), p = 0.008]. #evd-candidate
- There was a significant association between LEP and primary site of tumor (p < 0.01). #evd-candidate
- Kaplan-Meier curves for overall survival showed no significant differences between LEP and English proficient cohorts (p = 0.8063). #evd-candidate
- Kaplan-Meier curves for disease-specific survival showed no significant differences between LEP and English proficient cohorts (p = 0.4986). #evd-candidate
