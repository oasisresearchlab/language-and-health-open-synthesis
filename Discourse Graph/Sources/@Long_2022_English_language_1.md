...
author: Long
citekey: "@Long_2022_English_language_1"
has_empirical_findings: true
intervention: false
journal: Health Soc Care Community
keywords: |
  care of elderly people; emergency department; interpreters; language; LEP; nursing homes.
...
nodeInstanceId: 019e8dd8-2dca-74e7-815b-fe92e11ee48e
---


## Possible evidence

- In Local Hospital Network 1, 87.1% of LEP residents and 85.6% of non-LEP residents were admitted to the hospital after an ED visit (p = 0.57). #evd-candidate
- In Local Hospital Network 2, 76.0% of LEP residents and 76.9% of non-LEP residents were admitted to the hospital after an ED visit (p = 0.41). #evd-candidate
- No statistically significant differences were found in hospital admission rates between LEP and non-LEP residents in either local hospital network. #evd-candidate
- Communication difficulties were reported during the ED transfer process, but these did not appear to directly impact transfer or admission decisions. #evd-candidate
