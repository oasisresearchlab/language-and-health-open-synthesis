...
- 16% of the 13,104 patients were LEP patients. #evd-candidate
- LEP languages included 44% Chinese, 38% Spanish, and 18% categorized as "Other," representing 33 different languages. #evd-candidate
- LEP was associated with increased hospital length of stay (statistically significant, P = 0.003). #evd-candidate
- LEP patients were more likely to be discharged to home with home health services (statistically significant, P = 0.042). #evd-candidate
- LEP patients were more likely to be discharged to skilled nursing facility/rehabilitation (statistically significant, P = 0.006). #evd-candidate
- Mortality rate was 7% for LEP patients compared to 4% for English proficient patients (statistically significant, P < 0.0001). #evd-candidate
- Speaking an LEP language other than Chinese or Spanish was statistically significantly associated with increased mortality compared to English proficient patients (P = 0.006). #evd-candidate
