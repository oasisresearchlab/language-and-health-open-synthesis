...
author: Meischke
citekey: "@Meischke_2010_Emergency_communications"
has_empirical_findings: true
intervention: false
journal: Prehospital Emergency Care Journal
keywords: |
  dispatch, literacy, underserved populations, EMS, language proficiency, English proficiency
...
specialty: Emergency
title: Emergency communications with limited-English-proficiency populations
year: 2010
factors:
...
nodeInstanceId: 019e8dd8-2ef5-7275-84eb-b76cdae9078a
---


## Possible evidence

- 82% of telecommunicators filled out the survey. #evd-candidate
- 70% of telecommunicators reported encountering LEP callers almost daily. #evd-candidate
- 78% of telecommunicators reported that communication difficulties affect the medical care of LEP callers. #evd-candidate
- 36% of telecommunicators reported that calls with LEP callers are often stressful. #evd-candidate
- The Language Line was utilized in only 13% of LEP calls. #evd-candidate
- LEP callers received more repetition, rephrasing, and slowing of speech compared to non-LEP callers. #evd-candidate
- There was no difference in time from onset of call to dispatching basic life support (BLS). #evd-candidate
- There was a significant difference in simultaneous dispatching of BLS and ALS between LEP calls (20%) and non-LEP calls (38%, p < 0.05). #evd-candidate
