...
author: Muthukumar
citekey: "@Muthukumar_2021_Evaluating_frequency"
...
nodeInstanceId: 019e8dd8-2f9e-7f59-a097-3446b5ab575a
---


## Possible evidence

- 18.98% (n = 2,727) of clinical trials registered between January 2019 and December 2020 required the ability to read, speak, and/or understand English. #evd-candidate
- 2.71% (n = 390) of clinical trials specifically mentioned accommodation of translation to another language. #evd-candidate
- Among federally funded clinical trials (n = 2,585), 28.86% (n = 746) required English language proficiency and 4.68% (n = 121) specified accommodation of other languages. #evd-candidate
- Among industry-funded trials (n = 5,286), 5.30% (n = 280) required English and 0.49% (n = 26) accommodated other languages. #evd-candidate
- Infectious disease trials were less likely to specify an English requirement compared to all registered trials (10.07% versus 18.98%; relative risk = 0.53). #evd-candidate
- COVID-19 trials were less likely to specify an English requirement compared to all registered trials (8.18% versus 18.98%; relative risk = 0.43). #evd-candidate
- Trials with a posted protocol (n = 366) were more likely to specify an English requirement compared to all registered clinical trials (36.89% versus 18.98%; relative risk = 1.94). #evd-candidate
- In a separate analysis of studies with posted protocols in depression, diabetes, breast cancer, and prostate cancer, clinical trials related to depression were the most likely to require English (52.24%). #evd-candidate
