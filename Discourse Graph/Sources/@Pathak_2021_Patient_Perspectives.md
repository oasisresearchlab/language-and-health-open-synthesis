...
- Most patients reported "very good" or "excellent" quality of interpretation across all modalities. #evd-candidate
- In adjusted analysis, video medical interpreting (VMI) was rated highest (adjusted mean 3.91), followed by in-person interpreting (3.86), and then telephone interpreting (3.73) on the 5-item scale. #evd-candidate
- On the overall single quality item, VMI received the highest rating (adjusted mean 3.94), followed by in-person interpreting (3.85), and telephone interpreting (3.83). #evd-candidate
- Despite differences in ratings, no two-way comparisons between modalities were statistically significant (p values ranged from 0.15 to 0.95). #evd-candidate
