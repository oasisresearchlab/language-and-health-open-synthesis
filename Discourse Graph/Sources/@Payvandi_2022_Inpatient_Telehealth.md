---
abstract: |
  Background: Patients with limited English proficiency (LEP) are at a higher risk of poor health outcomes and are less likely to use telehealth than English-speaking patients. To date, there is no formal evaluation of inpatient (IP) telehealth user experience of patients and their families by language preference during visits with their clinicians. ^evd-6 ^Payvandi-2022-Inpati-L7 Objective: This study aims to compare the experiences of English- and Spanish-speaking patients and their families using IP telehealth, as well as to evaluate the experience of Spanish interpreters providing services through IP telehealth.
...
author: Payvandi
citekey: "@Payvandi_2022_Inpatient_Telehealth"
has_empirical_findings: true
intervention: false
journal: JMIR Form Res
keywords: |
  English as a second language; English proficiency; Spanish; health-related social needs; inpatient; LEP; social determinants of health; telehealth; telemedicine.
language: Spanish
...
nodeInstanceId: 019e8dd8-30a4-7396-b8fe-e553f63d0472
---


## Possible evidence

- A total of 661 surveys were administered, with completion rates of 18% (112/621) in English and 62% (25/40) in Spanish. #evd-candidate
- On a 10-point satisfaction scale, Spanish speakers had a median satisfaction score of 10 (IQR 10-10), which was significantly higher than English speakers' median score of 9 (IQR 8-10; P=.001). #evd-candidate
- Both English- and Spanish-speaking patients used inpatient telehealth for visits with their primary inpatient care team, subspecialty consultants, and other clinicians. #evd-candidate
- Hospital tablets were used more often than personal devices, and only English-speaking patients used personal laptops. #evd-candidate
- Patients and their families encountered challenges with log-in, team coordination with multiple users, and equipment availability. #evd-candidate
- Interpreters encountered challenges with audio and video quality, communication, safety, and Wi-Fi access. #evd-candidate
