...
abstract: |
  ...
  Conclusion: Our findings support the importance of structural and contextual factors as they relate to healthcare delivery. Healthcare organizations must address the needs of the population they serve and align their efforts internally. Current financial incentives do not appear to influence adoption of LS, nor do Medicaid reimbursement funds, thus suggesting that further alignment of incentives. Organizational and system level factors have a place in disparities research and warrant further analysis; additional spatial methods could enhance our understanding of population factors critical to system-level health services research.
author: Schiaffino
citekey: "@Schiaffino_2014_Predictors_language"
has_empirical_findings: true
intervention: false
journal: International Journal of Health Policy and Management
keywords: |
  Health Disparities; Healthcare Quality; Hospitals; Language Access; Limited English Proficiency (LEP).
...
study_years: 2011
title: Predictors of language service availability in U.S. hospitals
year: 2014
factors:
  - Limited English Proficiency (LEP)
outcomes_extracted:
  - Physician time/effort
nodeInstanceId: 019e8dd8-31f5-7790-b3f4-c19b899176e8
---


## Possible evidence

- Only 64% of hospitals offered Language Services (LS). #evd-candidate
- Hospitals that adopted LS were more likely to be not-for-profit. #evd-candidate
- Hospitals that adopted LS were more likely to be located in areas with higher than average language diversity. #evd-candidate
- Hospitals that adopted LS were more likely to be larger hospitals. #evd-candidate
- Hospitals that adopted LS were more likely to be urban hospitals. #evd-candidate
- Hospitals in counties with above average language diversity had more than 2-fold greater odds of adopting LS compared to less language diverse areas (Adjusted Odds Ratio: 2.26, P< 0.01). #evd-candidate
- Hospitals with a strategic orientation toward diversity had nearly 2-fold greater odds of adopting LS (Adjusted Odds Ratio: 1.90, P< 0.001). #evd-candidate
