...
author: Xie
citekey: "@Xie_2021_Developing_Machine"
has_empirical_findings: true
intervention: Bayesian classifier
...
nodeInstanceId: 019e8dd8-3495-740e-9247-9212f8ccfc70
---


## Possible evidence

- When using the optimised Bayesian machine learning classifier (GNB), the largest positive likelihood ratio (LR+) was 16.685 (95% confidence interval: 4.35, 64.04). #evd-candidate
- The probabilistic prediction achieved a sensitivity of 0.98 and specificity of 0.94 when the probability threshold was set at 0.2. #evd-candidate
