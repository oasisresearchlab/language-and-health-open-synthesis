...
id: E-0140
type: evidence
title: LEP status independently predicted increased 30-day DVT (aOR 2.84) after knee arthroplasty
...
# E-0140 — LEP status independently predicted increased 30-day DVT (aOR 2.84) after knee arthroplasty

## Description

![](/attachments/Kevin_2023_Limited_English-fig2.png)

On multivariable logistic regression adjusted for age, gender, BMI, ASA physical status, smoking status, and length of hospitalisation, limited English proficiency (LEP) remained an independent predictor of increased 30-day postoperative deep vein thrombosis (DVT) after elective total knee arthroplasty: adjusted odds ratio 2.84 (95% CI 1.19–6.79, p = 0.02) relative to English-proficient patients (Figure 2).
...
The observable: the covariate-adjusted odds of a 30-day postoperative DVT for LEP relative to EP patients, modeled as a binary outcome.
...
Multivariable logistic regression with a fixed a-priori covariate set drawn from prior arthroplasty literature; race/ethnicity were deliberately excluded from the model because of collinearity with English proficiency.
...
The 95% CI (1.19–6.79) is wide, reflecting the small number of DVT events; see the qualifying caveat on imprecise adjusted estimates.
