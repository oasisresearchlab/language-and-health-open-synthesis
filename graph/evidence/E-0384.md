...
id: E-0384
type: evidence
title: VERAA's LLM mapped numerical income-range responses least accurately (B1 income 70-75%)
...
# E-0384 — VERAA's LLM mapped numerical income-range responses least accurately (B1 income 70-75%)
...
The LLM was given the transcribed income response and instructed to select the matching structured income-range bin; accuracy was scored against the reviewer consensus ground truth across the three pipeline configurations. See A-0019.
